...
const sukhfxTexture = new THREE.TextureLoader().load('images/sukhfx.jpg');
...
const moonTexture = new THREE.TextureLoader().load('images/moon-defuse.jpg');
const moonTextureDepth = new THREE.TextureLoader().load('images/moon-normal.jpg');
